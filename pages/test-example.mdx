...
# Deploy to localhost (start hardhat node first)
npx hardhat node
...
- **Frontend Demos**:
  - [CDN Integration](https://hello-fhevm-game.vercel.app)
  - [SDK Integration](https://hello-fhevm-dice-site-d7kd.vercel.app/)
