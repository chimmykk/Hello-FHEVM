...
- Note this project structure is based on CDN integration
```
fhevm-dice-dapp/
├── 📁 contracts/
│   └── FHEDiceGame.sol           # Main smart contract with FHE logic
├── 📁 frontend/
│   ├── 📁 src/
│   │   ├── 📁 components/        # React components
│   │   │   ├── Header.js         # App header
│   │   │   ├── WalletConnect.js  # Wallet connection UI
│   │   │   ├── PlayDice.js       # Dice gameplay interface
│   │   │   ├── DiceResults.js    # Results display & decryption
│   │   │   ├── ContractInfo.js   # Contract information
│   │   │   ├── Footer.js         # App footer
│   │   │   └── ...
│   │   ├── 📁 hooks/            # Custom React hooks
│   │   │   ├── useWallet.js      # Wallet connection logic
│   │   │   ├── useDiceGame.js    # Contract interaction
...
├── 📁 tasks/
│   └── FHEDiceGame.ts           # Hardhat tasks for testing
├── 📁 test/
│   └── FHEDiceGame.ts           # Contract tests
├── 📁 deploy/
...
### **Frontend Setup:**
On the same project folder navigate for /frontend folder and install dependencies and start the development server
```bash
cd frontend
npm install
npm start
...
**Frontend**: [Using CDN](https://hello-fhevm-game.vercel.app)
[Using SDK](https://hello-fhevm-dice-site-d7kd.vercel.app/)
